(function () {
  ...
  const V = {
    ...
    onenimman: {
      ...
      intro: "Grab 來回。長輩可不去。下雨日全員商場備案之一。8/31 全員行程可與 Maya、SPA 排在同一區。",
      img: img.mall,
      maps: "One Nimman Chiang Mai",
      meta: ["90 分鐘", "室內平坦", "全員可去"],
    },
    maya: {
      name: "Maya Lifestyle Shopping Center",
      tag: "商場",
      highlight: "冷氣大商場，電梯扶手齊全，長輩逛得動；與 One Nimman 步行約 5–8 分鐘。",
      intro: "地下超市、頂樓戲院、中庭餐飲選擇多。全員可先在此會合、上洗手間、吹冷氣，再散步到 One Nimman。",
      img: img.mall,
      maps: "Maya Lifestyle Shopping Center Chiang Mai",
      meta: ["冷氣", "電梯", "全員可去"],
    },
    doisuthep: {
      name: "雙龍寺 Wat Phra That Doi Suthep",
      tag: "寺廟 · 半日",
      highlight: "山上金塔名寺，那迦（雙龍）階梯著名；旁邊有纜車/電梯可代步，長輩不必爬 306 級樓梯。",
      intro: "包車上山約 30–45 分鐘，山路多彎。到達後可搭電纜車上大平台，環境開闊、可俯瞰清邁市。遮膊遮膝、易穿脫鞋。上午去人潮較少、較涼快。",
      img: img.mountain,
      maps: "Wat Phra That Doi Suthep Chiang Mai",
      meta: ["半日", "有代步纜車", "遮膊遮膝"],
    },
    thaidress: {
      name: "泰服体验 · 古城租借拍照",
      tag: "體驗 · 全員",
      highlight: "回到舊城後全員換上泰服影相，老少都合適，不用另外走遠路。",
      intro: "古城內有多間泰服租借店，含化妝、頭飾，約 1–2 小時。可直接在店內或附近古城牆、廟前取景，坐着換裝、拍完就脫，不趕行程。",
      img: img.costume,
      maps: "Thai traditional dress rental Chiang Mai Old City",
      meta: ["1–2 小時", "老少皆宜", "古城取景"],
    },
    nimmanspa: {
      name: "Let's Relax Spa（寧曼分店）",
      tag: "按摩 · 全員",
      highlight: "連鎖水療，環境乾淨、位近 Maya／One Nimman，逛完商場直接全員做 SPA。",
      intro: "先訂全員腳底或油壓 60–90 分鐘。逛街走累剛好休息，做完直接叫車去機場。",
      img: img.spa,
      maps: "Let's Relax Spa Nimman Chiang Mai",
      meta: ["需預約", "近 Maya", "全員"],
    },
    suthepfoot: {
      food: true,
      name: "Aunt.Ni Bakery Cafe",
      tag: "餐廳 · 下山午餐",
      highlight: "素帖路山腳花園咖啡店，下雙龍寺後最順路的一餐，有冷氣室內位。",
      intro: "蛋糕＋輕食為主，也有簡單泰式餐。包車回程順路停，長輩不用再轉車進市區才吃飯。",
      img: img.brunch,
      maps: "Aunt.Ni Bakery Cafe Suthep Chiang Mai",
      meta: ["山腳", "冷氣室內", "輕食"],
      alts: [alts.thaanAoan, alts.rustic, alts.akhaAma],
    },
    nimmanlunch: {
      food: true,
      name: "Rustic & Blue",
      tag: "餐廳 · 寧曼午餐",
      highlight: "One Nimman 步行可達，庭院＋室內都好坐，逛完商場直接過來吃。",
      intro: "泰式家常＋輕食，環境舒服適合大人小孩。若客滿，旁邊咖啡店都在 5 分鐘步程內。",
      img: img.brunch,
      maps: "Rustic and Blue Nimman Chiang Mai",
      meta: ["近 One Nimman", "庭院＋室內", "全員可去"],
      alts: [alts.graph, alts.ristr8to, alts.akhaAma],
    },
  };
